 ...
 * "http://155.94.202.101:1009/api/v1/captcha/file/dynamic/8t91Rf02GV8moEZkqSVH.png"
 */
...
class Youknow extends Component {
  constructor(props){
    ...
    this.state = {
      ...
      IMG_URI: "",
      captcha: ""
      // "lRK8gj2hOELFZpoUXFQn.298324"
      // "GG3cPLVISxuuY9M3Lc40.298324"
    }
  }
  logIn() {
    let POST_URL='http://155.94.202.101:1009/api/v1/user/signin?captcha=wPwZVFw8YBJUflmVNXXu.777692';
    fetch(POST_URL, {
      method: 'POST',
      headers: {
